document.addEventListener('DOMContentLoaded', (e) => {
    ...
    function gameOver() {
        updateEnable = false
        elements.gameOverText.textContent = 'Set a goal and you will definitely succeed'
      
        elements.gameOverText.style.display = 'block'
    }
    function gameWin() {
        updateEnable = false
        elements.gameOverText.textContent = 'You are omnipotent,you will achieve everything because you won today.'
        elements.gameOverText.style.display = 'block'
    }
